...
\caption{
\textbf{
Summary of calibration in simulations involving $N=405$k white British individuals.} We report the false positive rate (FPR) at a significance threshold of $\alpha \in \{0.05, 0.0005\}$, calculated as the fraction of variants on even chromosomes with p-value lower than $\alpha$.
%
...
\subsection{Controlled false positive rates}
%
